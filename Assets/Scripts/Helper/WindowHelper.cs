...
public class WindowHelper
{
    ...
    public static void ExecuteCMD(CMDType type, int parm, bool isnotshow = false)
    {
        instance.ExecuteCMD(type, parm, isnotshow);
    }
    public static void ExecuteCMD(CMDType type, string parm, bool isnotshow = false)
    {
        instance.ExecuteCMD(type, parm, isnotshow);
    }
    public static void ExecuteCMD(CMDType type, bool parm, bool isnotshow = false)
    {
        instance.ExecuteCMD(type, parm, isnotshow);
    }
}