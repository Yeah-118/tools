...
public class WindowHelper
{
    ...
    public static bool IsWindowShowIng(int windowid)
    {
        return instance.IsWindowShowIng(windowid);
    }
    ...
    public static void HideAllWindow(int window = 0)
    {
        instance.HideAll(window);
    }
